    ...
    <>
      <Toolbar>
        ...
        <Button type="button" data-hs-editor-italic>
          ...
          >
            <path
              d="M11 5L14 5M17 5L14 5M14 5L10 19M14 5L12 12M12 12L15 12M12 12H8M12 12L13 19"
              stroke="currentColor"
              strokeWidth="1.5"
              strokeLinecap="round"
        ...
        <Button type="button" data-hs-editor-underline>
          ...
          >
            <path
              d="M8 5V11C8 11 8 14 12 14C16 14 16 11 16 11V5M5 19H19"
              stroke="currentColor"
              strokeWidth="1.5"
              strokeLinecap="round"
              strokeLinejoin="round"
        ...
        <Button type="button" data-hs-editor-strike>
          ...
          >
            <path
              d="M20 9.49995C20 8.99995 20 8.2 19 7.5C17 6.2 14 6 12 6C10 6 7 6.2 5 7.5C4 8.2 4 8.99995 4 9.49995M9 11.5H15M20 14.5C20 15 20 15.8 19 16.5C17 17.8 14 18 12 18C10 18 7 17.8 5 16.5C4 15.8 4 15 4 14.5M9 12.5H15"
              stroke="currentColor"
              strokeWidth="1.5"
            ></path>
          </svg>
        ...
        <Button type="button" data-hs-editor-ol>
          ...
          >
            <path
              d="M8 6H21M8 12H21M8 18H21M3 17.5V17C3 16.1716 3.67157 15.5 4.5 15.5C5.32843 15.5 6 16.1716 6 17V17.5C6 18.3284 5.32843 19 4.5 19H4M4.5 19V21.5M4.5 21.5H3M4.5 21.5H6M3 7H5L3 10H5"
              stroke="currentColor"
              strokeWidth="1.5"
              strokeLinecap="round"
              strokeLinejoin="round"
        ...
        <Button type="button" data-hs-editor-blockquote>
          ...
          >
            <path
              d="M7 18H5.6C5.26863 18 5 17.7314 5 17.4V14.6C5 14.2686 5.26863 14 5.6 14H7C7.82843 14 8.5 13.3284 8.5 12.5V11.5C8.5 10.6716 7.82843 10 7 10H5.6C5.26863 10 5 9.73137 5 9.4V7.6C5 7.26863 5.26863 7 5.6 7H7C8.65685 7 10 8.34315 10 10V12C10 13.6569 8.65685 15 7 15M19 18H17.6C17.2686 18 17 17.7314 17 17.4V14.6C17 14.2686 17.2686 14 17.6 14H19C19.8284 14 20.5 13.3284 20.5 12.5V11.5C20.5 10.6716 19.8284 10 19 10H17.6C17.2686 10 17 9.73137 17 9.4V7.6C17 7.26863 17.2686 7 17.6 7H19C20.6569 7 22 8.34315 22 10V12C22 13.6569 20.6569 15 19 15"
              stroke="currentColor"
              strokeWidth="1.5"
            ></path>
          </svg>
        ...
        <Button type="button" data-hs-editor-code>
          ...
          >
            <path
              d="M13 6L9 18M9 13L5 9M9 13L5 17M15 13L19 9M15 13L19 17"
              stroke="currentColor"
              strokeWidth="1.5"
              strokeLinecap="round"
              strokeLinejoin="round"
